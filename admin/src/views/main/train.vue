...
export default defineComponent({
  ...
  setup() {
    ...
    const onDelete = (record) => {
      axios.delete("/business-service/admin/train/delete/" + record.id).then((response) => {
    ...
    const handleOk = () => {
      axios.post("/business-service/admin/train/save", train.value).then((response) => {
    ...
    const handleQuery = (param) => {
      ...
      loading.value = true;
      axios.get("/business-service/admin/train/query-list", {
        params: {
          page: param.page,
          size: param.size
        }
    ...
    const genSeat = (record) => {
      loading.value = true;
      axios.get("/business-service/admin/train/gen-seat/" + record.code).then((response) => {
        loading.value = false;
        const data = response.data;
        if (data.success) {
