...
export default defineComponent({
  ...
  setup() {
    ...
    const onDelete = (record) => {
      axios.delete("/business-service/admin/daily-train-seat/delete/" + record.id).then((response) => {
    ...
    const handleOk = () => {
      axios.post("/business-service/admin/daily-train-seat/save", dailyTrainSeat.value).then((response) => {
    ...
    const handleQuery = (param) => {
      ...
      loading.value = true;
      axios.get("/business-service/admin/daily-train-seat/query-list", {
        params: {
          page: param.page,
          size: param.size
        }
