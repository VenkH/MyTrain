...
export default defineComponent({
  ...
  setup() {
    ...
    const onDelete = (record) => {
      axios.delete("/business-service/admin/daily-train-ticket/delete/" + record.id).then((response) => {
    ...
    const handleOk = () => {
      axios.post("/business-service/admin/daily-train-ticket/save", dailyTrainTicket.value).then((response) => {
    ...
    const handleQuery = (param) => {
      ...
      loading.value = true;
      axios.get("/business-service/admin/daily-train-ticket/query-list", {
        params: {
          page: param.page,
          size: param.size,
