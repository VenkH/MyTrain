package com.kyr.mytrain.${module}.service;
...
import com.kyr.mytrain.${module}.domain.${Domain};
import com.kyr.mytrain.${module}.domain.${Domain}Example;
import com.kyr.mytrain.${module}.mapper.${Domain}Mapper;
