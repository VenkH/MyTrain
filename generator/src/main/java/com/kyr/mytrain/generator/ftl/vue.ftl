...
export default defineComponent({
  ...
  setup() {
    ...
    const onDelete = (record) => {
      axios.delete("/${module}-service/admin/${do_main}/delete/" + record.id).then((response) => {
    ...
    const handleOk = () => {
      axios.post("/${module}-service/admin/${do_main}/save", ${domain}.value).then((response) => {
    ...
    const handleQuery = (param) => {
      ...
      loading.value = true;
      axios.get("/${module}-service/admin/${do_main}/query-list", {
        params: {
          page: param.page,
          size: param.size
        }
